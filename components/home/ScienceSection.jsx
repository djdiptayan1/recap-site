export default function ScienceSection() {
    const memoryTypes = [
        ...
        },
        {
            ...
            appApproach: "Cognitive games exercise short-term recall through pattern matching and spatial recognition. Journal entries with voice recordings also reinforce immediate memory encoding.",
        },
        {
            type: "Recent Memory",
            appLabel: "Remote",
