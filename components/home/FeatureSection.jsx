...
const features = [
    {
        ...
        description: "Smriti uses Apple Foundation Models on supported iPhone 15 Pro+ devices, and automatically routes to Recap's custom AI service for all other cases.",
        icon: (
    ...
    },
    {
        ...
        description: 'Create mood-aware journal entries with text, voice recordings, and photos. Tag people, places, and events to build a rich personal memory archive.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#0B8494]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
