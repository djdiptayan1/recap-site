...
export default function Support() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Family members connect using the patient\u2019s unique Patient ID. When a family member signs up, they enter this ID to link their accounts. This allows them to create daily questions, view progress analytics, monitor streaks, coordinate reminders, and share photos and stories."
        },
        {
            id: 3,
            question: "What types of memory does Recap assess?",
            answer: "Recap assesses three clinically recognized memory types: Immediate memory (short-term) \u2014 things that happened minutes or hours ago; Recent memory \u2014 events from days to weeks ago; and Remote memory (long-term) \u2014 memories from years ago. Daily questions and assessments cover all three types."
        },
        {
            id: 4,
            question: "What cognitive games are available?",
            answer: "Recap includes multiple cognitive games designed to exercise different mental skills including spatial memory, pattern matching, and visual recognition. Games are designed to be enjoyable while providing genuine cognitive benefit."
        },
        {
            id: 5,
        ...
        },
        {
            ...
            answer: "Recap supports reminders for a wide range of daily needs including medication, appointments, exercise, meals, and more. Reminders can be set with flexible scheduling options to fit any routine."
        },
        {
            id: 7,
            question: "How does progress tracking work?",
            answer: "Recap provides visual analytics showing cognitive performance trends over daily, weekly, and monthly timeframes. It tracks accuracy across different memory categories and can alert caregivers to concerning patterns."
        },
        {
            id: 8,
            question: "Can healthcare providers access the progress reports?",
            answer: "Yes. Recap generates cognitive assessment reports that can be shared with healthcare providers. These reports include trend data that can help inform clinical assessments and treatment decisions."
        },
        {
            id: 9,
            question: "How does Recap adapt to different Alzheimer\u2019s stages?",
            answer: "During setup, patients or caregivers select the current Alzheimer\u2019s stage: Early, Middle, or Advanced. The app uses this information to provide appropriate engagement tailored to the patient\u2019s cognitive level."
        }
    ];
